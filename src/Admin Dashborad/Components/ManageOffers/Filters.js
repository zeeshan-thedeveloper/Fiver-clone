...
function Filters(props) {
    ...
    const filterBy_titles={
        filter_by_title_1:"By Sub Catagory",
        filter_by_title_2:"By Catagory",
        filter_by_title_3:"By Rating",
        filter_by_title_4:"By Creation Date",
        filter_by_title_5:"By Hits number",  
        filter_by_title_6:"By Status",  
        filter_by_title_7:"By Id",  
    ...
    const handeShowOnlineUsersFilter=(e)=>{
        addElementInFilterList("Published",filterBy_titles_type.filter_by_title_6_type,filterBy_titles.filter_by_title_6+": Show Published Offers")          
    }
    const handeShowOfflineUsersFilter=(e)=>{

        addElementInFilterList("Not Published",filterBy_titles_type.filter_by_title_6_type,filterBy_titles.filter_by_title_6+": Show Un-Published")          
    }
            ...
            <CardContent>
                <div style={{position:'relative'}}>
                    ...
                    <div style={{position:'absolute',top:0,right:0}}>
                            <Button color="primary" variant="outlined" onClick={handeShowOnlineUsersFilter}>Show Published</Button>
                    </div>
                    <div style={{position:'absolute',top:0,right:'10rem'}}>
                            <Button color="primary" variant="outlined" onClick={handeShowOfflineUsersFilter}>Show Not Published</Button>
                    </div>
                </div>
