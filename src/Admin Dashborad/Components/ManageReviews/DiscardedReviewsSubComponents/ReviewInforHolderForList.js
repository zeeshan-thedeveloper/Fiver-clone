        ...
        <div>
            <Grid container>
              ...
              <Grid item xs={12}>
                ...
                <div style={{borderBottom:lightBorder,backgroundColor:'red'}}>
                  <Headings text={`Dicard date and time: ${props.data.reviewDiscardingDate} @  ${props.data.reviewDiscardingTime}`} fontSize={17} fontWeight={'bold'}/>
                </div>
