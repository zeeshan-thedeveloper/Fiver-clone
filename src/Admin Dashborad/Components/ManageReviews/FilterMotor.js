                    ...
                    if(searchKeyPairItem.typeofValue==="Array")
                                        {
                                            ...
                                            let flag = true;
                                            console.log("Matching in Array "+dataItem[searchKeyPairItem.withRespectTo])
                                        ...
                                        else if (searchKeyPairItem.typeofValue==="Object")
                                        {
                                            ...
                                            console.log("Matching in Object "+dataItem[searchKeyPairItem.withRespectTo])
                                        ...
                                        else if(searchKeyPairItem.typeofValue==="SingleValueInteger")
                                        {
                                            ...
                                            numberOfTimesRequired++;
                                            console.log("Matching in SingleValueInteger "+dataItem[searchKeyPairItem.withRespectTo])
                                        ...
                                        else if(searchKeyPairItem.typeofValue==="SingleValueString")
                                        {
                                            ...
                                            numberOfTimesRequired++;
                                            console.log("Matching in SingleValueString "+dataItem[searchKeyPairItem.withRespectTo])
                                            if(searchKeyPairItem.values===dataItem[searchKeyPairItem.withRespectTo])
                                            {
                                               console.log(`Key: ${searchKeyPairItem.withRespectTo} matched for item index : ${index_data_to_filter+1}`)
                                               numberOfTimesMatched++;     
                                        ...
                                        else if(searchKeyPairItem.typeofValue==="Range")
                                        {
                                            // [Min,Max]
                                            numberOfTimesRequired++;
                                            console.log("Matching in range "+dataItem[searchKeyPairItem.withRespectTo])
                                            console.log("Values are "+searchKeyPairItem.values[0]+" and "+searchKeyPairItem.values[1])
