...
import {selectServiceClicksOverViewChartData} from '../Redux Components/Selectors'
import { loadServiceClicksOverViewChartData } from '../Redux Components/Thunks';
import { useSelector,useDispatch } from 'react-redux';
import Skeleton from '@material-ui/lab/Skeleton';
import { selectAll } from '../Redux Components/Selectors';
...
function ServicesClickHistoryOverViewChart(props) {
	...
	const {isLoading_loadServiceClicksOverViewChartData} = useSelector(selectAll);
	const dataPointsResponse = useSelector(selectServiceClicksOverViewChartData);
	...
	},[isLoading_loadServiceClicksOverViewChartData,dataPointsResponse])
	useEffect(()=>{
		//When history opt changes.
		dispatch(loadServiceClicksOverViewChartData({selectedPeriod})); 
	},[selectedPeriod]);
	...
	return (
		<div>
		{
			(isLoading_loadServiceClicksOverViewChartData) ? (
