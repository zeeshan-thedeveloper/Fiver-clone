...
import ServicesClickHistoryOverViewChart from './ServicesClickHistoryOverViewChart';
    ...
    return (
          ...
          action={
            <div>
                <div className={classes.overViewHeadingTitle}>
                    <Headings text={"Service Clicks overview"} fontSize={25} fontWeight={'bold'}/>
                </div>
        ...
        <CardContent>
          ...
          <div className={classes.chartContainer}>
                <ServicesClickHistoryOverViewChart graphMode={selectGraphMode} selecteHistoryValue={selecteHistoryValue}/>
          </div>
