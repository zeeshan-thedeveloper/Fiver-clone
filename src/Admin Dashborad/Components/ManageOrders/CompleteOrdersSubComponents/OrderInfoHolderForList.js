        ...
        <div>
            <Grid container>
                ...
                <Grid item xs={6} style={{padding:'1rem',border:lightBorder}} >
                    <Headings text={`orderId :  ${props.data.orderId}`} fontWeight={'bold'}/>
                </Grid>
                <Grid item xs={6} style={{padding:'1rem',border:lightBorder}} >
                   <Headings text={`Order Estimated Price :  ${props.data.orderEstimatedPrice}`} fontWeight={'bold'}/>
                </Grid>
                <Grid item xs={6} style={{padding:'1rem',border:lightBorder}} >
                    <Headings text={`Delivery Date :  ${props.data.orderDeliveryDate}`} fontWeight={'bold'}/>
                </Grid>
                <Grid item xs={6} style={{padding:'1rem',border:lightBorder}} >      
                    <Headings text={`Placement Date :  ${props.data.orderPlacementDate}`} fontWeight={'bold'}/> 
                </Grid>
                <Grid item xs={6} style={{textAlign:'center',padding:'1rem',border:lightBorder}}>
                    <Headings text={`Start date :  ${props.data.orderStartDate}`} fontWeight={'bold'}/>
                </Grid>
                <Grid item xs={6} style={{textAlign:'center',padding:'1rem',border:lightBorder}}>
                    <Headings text={`Complete date :  ${props.data.orderCompletionDate} `} fontWeight={'bold'}/>
                </Grid>
                <Grid item xs={12} style={{textAlign:'center',padding:'1rem',border:lightBorder}}>
