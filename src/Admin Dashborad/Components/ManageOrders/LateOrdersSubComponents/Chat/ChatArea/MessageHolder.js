...
const MessageHolder = withStyles(defaultChatMsgStyles, { name: 'ChatMsg' })(props => {
          ...
          { (!isFile && isImage && !isVideo) && images.map((img, i) => {
            ...
            return (
              ...
              <div key={img.id || i} className={classes[`${side}Row`]}>
                ...
                <div className={styles.fileHolder} style={{marginLeft:(isLeft) ? "0%" : "49%"}}>
                    <Grid  container>

                    <Grid item xs={2} style={{textAlign:'center'}}>
                        {/* Icon */}
                        <FontAwesomeIcon icon={faFileImage  } size="2x" style={{marginTop:'30%'}} />
                    </Grid>
                    <Grid item xs={8} style={{textAlign:'left',paddingLeft:1}}>
                        {/* Icon */}
                        <h4>{img.imageTitle}</h4>
                    </Grid>
                    <Grid item xs={2} style={{textAlign:'center'}}>
                        {/* Icon */}
                        <FontAwesomeIcon icon={faDownload} size="2x" style={{marginTop:'30%'}} />
                    </Grid>
                    </Grid>
            ...
            return (
              ...
              <div key={file.id || i} className={classes[`${side}Row`]}>
                <div className={styles.fileHolder} style={{marginLeft:(isLeft) ? "0%" : "49%"}}>
                    ...
                    <Grid item xs={2} style={{textAlign:'center'}}>
                        {/* Icon */}
                        <FontAwesomeIcon icon={faFile} size="2x" style={{marginTop:'30%'}} />
                    </Grid>
                    <Grid item xs={8} style={{textAlign:'left',paddingLeft:1}}>
                        {/* Icon */}
                        <h4>{file.fileName}</h4>
