...
function CancelOrder(props) {
    ...
    const handelRejectBtnEvent = ()=>{
        alert("Call the thunk to reject order...");
    }
    return (
        <div>
            <Grid container>
                ...
                <div style={{display:'inline-block'}}>
                    <Headings text={"Order cancelation "} fontSize={25} fontWeight={'bold'}/>
                </div>
                <div style={{display:'inline-block',marginLeft:'1rem'}}>
                    <Headings text={`Order ID : ${props.selectedOrder.orderId}`} fontSize={20} fontWeight={''}/>
                </div>
