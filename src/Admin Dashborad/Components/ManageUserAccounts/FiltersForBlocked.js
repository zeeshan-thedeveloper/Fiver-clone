...
function FiltersForBlocked(props) {
    const classes=useStyles();
    const filterBy_titlesFonts=18;
    const [searchValue,setSearchValue]=useState('');
    // This will be filled from API data
    const filterBy_titles={
        filter_by_title_1:"By Account Status",
        filter_by_title_2:"By Country",
        filter_by_title_3:"By Rating",
        filter_by_title_4:"By Account Creation Date",
        filter_by_title_5:"By Total amount spent",  
        filter_by_title_6:"By Online Status",  
        filter_by_title_7:"By User Name",  
    ...
    const [filter_by_title_1_Options,setFilter_by_title_1_Options]=useState([
        {
            OptionLabel:"Verified",
            OptionValue:"Verified",
            optionIndex:"0",
            isCheked:false
        },
        {
    ...
    const handeSearchButton=(e)=>{
        addElementInFilterList(searchValue,filterBy_titles_type.filter_by_title_7_type,filterBy_titles.filter_by_title_7+": "+searchValue)          
    }

    const handeShowOnlineUsersFilter=(e)=>{
        addElementInFilterList("Online",filterBy_titles_type.filter_by_title_6_type,filterBy_titles.filter_by_title_6+": Show Online Users")          
    }
    const handeShowOfflineUsersFilter=(e)=>{

        addElementInFilterList("Offline",filterBy_titles_type.filter_by_title_6_type,filterBy_titles.filter_by_title_6+": Show Online Users")          
    }
    ...
    const [listOfOptions_filter_by_title_2_RadioBoxes,setListOfOptions_filter_by_title_2_RadioBoxes] =useState([
        ...
        {
            optionLabel:"Indoneshia",
            optionValue:"Indoneshia",
            radioBtnColor:'primary'
        },
        {
            optionLabel:"USA",
                ...
                <div style={{position:'relative'}}>
                    <div style={{paddingBottom:'4rem'}}>
                            <div style={{position:'absolute',top:0,left:1}}>
                                <Headings text={"Search "} fontSize={25} fontWeight={'bold'}/>
                            </div>
                            <div  style={{position:'absolute',top:0,left:'6rem'}}>
                                 <SimpleTextFields 
                                    fontSize={14} 
                                    fontWeight={'bold'}
                                    label={"Search vy user name"} 
                                    value={searchValue} 
                            ...
                            <div style={{position:'absolute',top:2,left:'18.5rem',cursor:'pointer'}} onClick={handeSearchButton}>
                    ...
                    {/* <div style={{position:'absolute',top:0,right:0}}>
                            <Button color="primary" variant="outlined" onClick={handeShowOnlineUsersFilter}>Show Online</Button>
                    </div>
                    <div style={{position:'absolute',top:0,right:'9rem'}}>
                            <Button color="primary" variant="outlined" onClick={handeShowOfflineUsersFilter}>Show Offline</Button>
                    </div> */}
                </div>
               ...
               {(props.listOfOptions_ForChipList.length!=0) &&(   
                ...
                >
                           <AccordionSummary
                             ...
                             id="panel1a-header"
                           >
                               <Headings text={"Applied FiltersForBlocked"} fontSize={20} fontWeight={'bold'}/>
...
export default FiltersForBlocked;