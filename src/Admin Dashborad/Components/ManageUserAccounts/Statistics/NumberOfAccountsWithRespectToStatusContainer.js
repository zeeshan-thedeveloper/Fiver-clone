...
import NumberOfAccountsWithRespectToStatusChart from './Charts/NumberOfAccountsWithRespectToStatusChart';
import Dropdown from '../../Support/Dropdown';
import GroupedRadioButtons from '../../Support/GroupedRadioButtons'

function NumberOfAccountsWithRespectToStatusContainer(props) {
    ...
    return (
        ...
        <CardContent>
          <div className={classes.chartContainer}>
                <NumberOfAccountsWithRespectToStatusChart graphMode={selectGraphMode} selecteHistoryValue={selecteHistoryValue}/>
          </div>
        </CardContent>
...
export default NumberOfAccountsWithRespectToStatusContainer;