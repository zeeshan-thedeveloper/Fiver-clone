...
import ShowNewRequestsTab from './ShowNewRequestsTab';
import ShowDeclinedRequests from './ShowDeclinedRequests';


function ManageOrderRequests(props) {
        ...
        <Grid container>
           ...
           <Grid item lg={12} xs={12}>
             <Card className={classes.tabBarAndFilersContainer}>
               <CardContent>
                 <Headings text={"Order Requests Manager"} fontSize={30} fontWeight={'bolder'}/>
                 <AppBar position="static" color="inherit"
                  ...
                  >
                     ...
                     >
                          ...
                          <Tab className={classes.tabElementStyle} label={"New requests"} {...a11yProps(0)} />
                          <Tab className={classes.tabElementStyle} label={"Declined requests"} {...a11yProps(1)} />
