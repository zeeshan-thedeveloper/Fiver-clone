                    ...
                    <Grid container style={{marginTop:'2.5rem'}}>
                                ...
                                <Grid item xs={5} style={{backgroundColor:''}}>
                                    ...
                                    <Grid container>
                                        ...
                                        <Grid item xs={12}>
                                            ...
                                            <Headings text={`Date and time of decline : ${props.selectedRequest.requestDeclineDate} @ ${props.selectedRequest.requestDeclineTime}`} fontWeight={'bold'} fontSize={12}/>
                                        </Grid>
                        ...
                        <Grid container style={{border:lightBorder,padding:'1rem'}}>
                            ...
                            <Grid item xs={12} style={{backgroundColor:'red'}}>
                                {/* Reason of decline */}
                                <Headings text={ ` Reason of decline : ${props.selectedRequest.requestDeclineReason}`} fontWeight={'bold'}/>
                            </Grid>
                            <Grid item xs={12} >
                                {/* Note to client */}
                                <Headings text={ ` Note to client : ${props.selectedRequest.requestDeclineReason}`} fontWeight={'bold'}/>
                            </Grid>
                        </Grid>
